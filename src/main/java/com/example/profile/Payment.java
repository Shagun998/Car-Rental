...
public class Payment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        name.setText("Shagun Bhardwaj");
        upiId.setText("ssharma998855@okhdfcbank");
        note.setText("test");
        amount.setText("10");
    ...
    private void payWithGpay(String packageName){
        ...
        if(isAppInstalled(this,packageName)){
            ...
            Toast.makeText(Payment.this,"Google pay is not installed. Please install and try again.", Toast.LENGTH_SHORT).show();
        }
